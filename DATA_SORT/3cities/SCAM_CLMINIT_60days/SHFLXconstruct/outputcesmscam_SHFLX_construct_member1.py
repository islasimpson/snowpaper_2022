...
expname=("SCAM_CLM5_CLM5F_01","SCAM_SNOWD_CLM5F_01")
...
shflx = xr.open_dataset(basedir+"SHFLX_SCAM_CLM5_CLM5F_01.nc")
shflx_deseas = calcdeseas(shflx.shflx)
ts = xr.open_dataset(basedir+"TS_SCAM_CLM5_CLM5F_01.nc")
ts_deseas = calcdeseas(ts.ts)
tbot = xr.open_dataset(basedir+"TBOT_SCAM_CLM5_CLM5F_01.nc")
