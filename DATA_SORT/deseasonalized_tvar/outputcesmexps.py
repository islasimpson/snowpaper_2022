...
#expnames=['Isla_CAM6_CLM5','Isla_CAM6_CLM5_002']
expnames=['Isla_CAM6_CLM5','Isla_CAM6_CLM5_002','CAM6_CLM5_snowdensity','CAM6_CLM5_snowdensity_002']
...
for iexp in expnames:
    ...
    datseason.to_netcdf(path=fout,mode="a")
