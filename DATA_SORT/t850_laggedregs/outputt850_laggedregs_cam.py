...
t850_clm5 = readanddeseas(filepath+"T850_Isla_CAM6_CLM5.nc",filepath+"T850_Isla_CAM6_CLM5_002.nc",
                          "t850")

t850_snowd = readanddeseas(filepath+"T850_CAM6_CLM5_snowdensity.nc",
                           filepath+"T850_CAM6_CLM5_snowdensity_002.nc",
                           "t850")

trefht_clm5 = readanddeseas(filepath+"TREFHT_Isla_CAM6_CLM5.nc",
                            filepath+"TREFHT_Isla_CAM6_CLM5_002.nc",
                            "trefht")

trefht_snowd = readanddeseas(filepath+"TREFHT_CAM6_CLM5_snowdensity.nc",
                             filepath+"TREFHT_CAM6_CLM5_snowdensity_002.nc",
                             "trefht")

ts_clm5 = readanddeseas(filepath+"TS_Isla_CAM6_CLM5.nc",
                        filepath+"TS_Isla_CAM6_CLM5_002.nc",
                        "ts")

ts_snowd = readanddeseas(filepath+"TS_CAM6_CLM5_snowdensity.nc",
                         filepath+"TS_CAM6_CLM5_snowdensity_002.nc",
                         "ts")

tbot_clm5 = readanddeseas(filepath+"TBOT_Isla_CAM6_CLM5.nc",
                          filepath+"TBOT_Isla_CAM6_CLM5_002.nc",
                          "tbot")

tbot_snowd = readanddeseas(filepath+"TBOT_CAM6_CLM5_snowdensity.nc",
                           filepath+"TBOT_CAM6_CLM5_snowdensity_002.nc",
                           "tbot")

flns_clm5 = readanddeseas(filepath+"FLNS_Isla_CAM6_CLM5.nc",
                          filepath+"FLNS_Isla_CAM6_CLM5_002.nc",
                          "flns")

flns_snowd = readanddeseas(filepath+"FLNS_CAM6_CLM5_snowdensity.nc",
                           filepath+"FLNS_CAM6_CLM5_snowdensity_002.nc",
                           "flns")

fsns_clm5 = readanddeseas(filepath+"FSNS_Isla_CAM6_CLM5.nc",
                          filepath+"FSNS_Isla_CAM6_CLM5_002.nc",
                          "fsns")

fsns_snowd = readanddeseas(filepath+"FSNS_CAM6_CLM5_snowdensity.nc",
                           filepath+"FSNS_CAM6_CLM5_snowdensity_002.nc",
                           "fsns")

lhflx_clm5 = readanddeseas(filepath+"LHFLX_Isla_CAM6_CLM5.nc",
                           filepath+"LHFLX_Isla_CAM6_CLM5_002.nc",
                           "lhflx")

lhflx_snowd = readanddeseas(filepath+"LHFLX_CAM6_CLM5_snowdensity.nc",
                            filepath+"LHFLX_CAM6_CLM5_snowdensity_002.nc",
                            "lhflx")

shflx_clm5 = readanddeseas(filepath+"SHFLX_Isla_CAM6_CLM5.nc",
                           filepath+"SHFLX_Isla_CAM6_CLM5_002.nc",
                           "shflx")

shflx_snowd = readanddeseas(filepath+"SHFLX_CAM6_CLM5_snowdensity.nc",
                            filepath+"SHFLX_CAM6_CLM5_snowdensity_002.nc",
                            "shflx")
