...
basepath="/project/cas/islas/python_savs/snowpaper/DATA_SORT/3cities/SCAM/new_lowrelax/"
...
try:
    os.remove(outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc")
except:
    pass


trefht_clm5_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc")
trefht_snowd_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc", mode="a")
ts_clm5_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc", mode="a")
ts_snowd_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc", mode="a")
tsl_clm5_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc", mode="a")
tsl_snowd_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc", mode="a")
tbot_clm5_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc", mode="a")
tbot_snowd_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc", mode="a")
snot_clm5_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc", mode="a")
snot_snowd_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc", mode="a")
t_clm5_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc", mode="a")
t_snowd_xr.to_netcdf(path=outpath+"trefhtptilecomposites_3cities_scamlowrelax.nc", mode="a")
